...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "u6AOxG5hlCEGTZPBWNGyJREMQBfWCuIh";
	...
	public List<Item> search(double lat, double lon, String term) {
		...
		// apiKey = u6AOxG5hlCEGTZPBWNGyJREMQBfWCuIh
		String query = String.format("apikey=%s&geppoint=%s&keyword=%s&radius=%s", API_KEY, geoHash, term, 50);
